    ...
    <div className={cn("flex flex-col", className)}>
      <div
        className={cn(
          ...
          compact && "text-[1.4rem] tracking-[0.1em] sm:text-[1.6rem] sm:tracking-[0.12em]",
          titleClassName,
        )}
      >
        <span>CINE</span>
      ...
      <p
        className={cn(
          ...
          compact && "mt-0 text-[0.50rem] tracking-[0.18em] text-white/68 sm:text-[0.60rem] sm:tracking-[0.24em]",
          subtitleClassName,
        )}
      >
